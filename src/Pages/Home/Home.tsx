    ...
    <Frame footerRef={myRef}>
        <div className="landing">
            <div className='body'>
                ...
                <div className="detail">Monerce is an Online-To-Offline (O2O) commerce digital solution that enable people to buy and sell goods and services via existing text based messaging services using integration with USSD based services.</div>
                <div className="btn">
                    <Button className="join-btn" type="button" onClick={executeScroll}>Join the wait list</Button>
                </div>
            </div>
            <div className="image">
        ...
        <div className="offering">
            ...
            <div className="sub-title">Here are the few things you will be able to  accomplish with our value-added product:</div>
            <div className="cards">
                <WhiteCard 
                    icon='buy'
                    title='Buy'
                    detail='Make a purchase of goods/services from merchants via SMS'
                />
                <WhiteCard 
                    icon='book'
                    title='Book'
                    detail='Reserve a spot for an  event all by just sending an SMS'
                />
                <WhiteCard 
                    icon='give'
                    title='Give'
        ...
        <div className="channel">
            ...
            <div className="cards">
                <GreyCard 
                    icon='messages'
                    title='SMS'
                    detail='Send a text message to our SMS Gateway number'
                />
                <GreyCard 
                    icon='whatsapp'
                    title='Whatsapp'
                    detail='Send a WhatsApp message to our Platform Number'
                />
                <GreyCard 
                    icon='Facebook'
                    title='Facebook'
